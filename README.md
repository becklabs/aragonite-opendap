...
1. **Download the `data_artifacts.zip` archive (~500MB) from the [Google Drive Link](https://drive.google.com/file/d/1w9pq5Gfqottebf14BIf7gaBQy7mpHlKR/view?usp=sharing).**
